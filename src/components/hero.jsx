...
export default function Hero() {
    return (
        <header className='hero flex justify-center p-4 flex-col gap-5 '>
            ...
            <button className='bg-white text-sm text-black w-40 p-2 rounded-md hover:bg-gray-100 flex items-center gap-2'>Shop Collection <span><FaArrowRight /></span></button>
        </header>
    )
}
